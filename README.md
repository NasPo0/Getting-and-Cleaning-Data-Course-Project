...
All variables, data sets and transformations to the data is described in the script 'CodeBook.md'.

The used data set and the following descriptions are from [1].
